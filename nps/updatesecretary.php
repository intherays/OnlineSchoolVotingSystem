...
$g2=$_POST['g2'];
$g3=$_POST['g3'];
echo "Category  : ".$_POST['cat']."<br>";
echo "<br>".$cat."<br>".$b1."<br>".$b2."<br>".$b3."<br>".$g1."<br>".$g2."<br>".$g3;
...
// Group Condition
    ...
    $cid = "Boy-".$cat."-".($i+1);
    echo "<br>cid :  ". $cid;
    $sql="insert into secretary values ('".$cat."','boy','". $cid."','". $boyname[$i]."',0)";
 ...
 for($i=0;$i<3;$i++){
    ...
    $cid = "Girl-".$cat."-".($i+1);
    echo "<br>cid : ". $cid;
    $sql="insert into secretary values ('".$cat."','girl','". $cid. "','". $girlname[$i]."',0)";
    echo "<br><br>" .$sql." <br><br>";
    $result =  mysqli_query($con, $sql);
