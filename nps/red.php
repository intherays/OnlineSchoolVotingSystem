...
?>
    <section class="container">
        <form method="" action="voteRed.php">
            <div class="row">
                <!-- Captain -->
                <div class="col-md-6 ">
                    <div class="panel panel-danger">
                        ...
                        <div class="col-md-6">
                            <ul class="list-group">
                                ...
                                <?php 
                        $sqlCaptain = "SELECT * FROM red WHERE cat='Captain' AND gender='boy'";
                        ...
                        <div class="col-md-6">
                            <ul class="list-group">
                                ...
                                <?php 
                        $sqlCaptain = "SELECT * FROM red WHERE cat='Captain' AND gender='girl'";
                        $result = mysqli_query($con,$sqlCaptain);
                        //echo "Query Result is : ".mysqli_num_rows($result);
                        if (mysqli_num_rows($result) > 0) {
                            while($row = mysqli_fetch_array($result)) { ?>
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="col-md-6">
                            <ul class="list-group">
                                <li><label>Boys</label></li>
                                <?php 
                        $sqlCaptain = "SELECT * FROM red WHERE cat='Vice-Captain' AND gender='boy'";
                        $result = mysqli_query($con,$sqlCaptain);
                        //echo "Query Result is : ".mysqli_num_rows($result);
                        if (mysqli_num_rows($result) > 0) {
                            while($row = mysqli_fetch_array($result)) { ?>
                        ...
                        <div class="col-md-6">
                            <ul class="list-group">
                                <li><label>Girls</label></li>
                                <?php 
                        $sqlCaptain = "SELECT * FROM red WHERE cat='Vice-Captain' AND gender='girl'";
                        $result = mysqli_query($con,$sqlCaptain);
                        //echo "Query Result is : ".mysqli_num_rows($result);
                        if (mysqli_num_rows($result) > 0) {
                            while($row = mysqli_fetch_array($result)) { ?>
